...
| [Appendix C: A major infrastructure change, made easy<br/>附录C：轻松更换重要的基础设施（已翻译）](appendix_csvs.asciidoc)                  | [![Build Status](https://travis-ci.org/cosmicpython/code.svg?branch=appendix_csvs)](https://travis-ci.org/cosmicpython/code) |
